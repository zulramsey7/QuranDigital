...
const sirahData = {
  nabawiyah: [
    ...
    { id: 104, title: "Hijrah Madinah", content: "Baginda berhijrah ke Madinah bersama Abu Bakar. Di sana, Baginda membina Masjid Nabawi dan mempersaudarakan kaum Muhajirin dan Ansar.", icon: <MapPin className="w-5 h-5" />, color: goldGradient }
  ],
  paraNabi: [
    { id: 1, title: "Nabi Adam AS", content: "Manusia pertama diciptakan dari tanah. Tinggal di Syurga sebelum diturunkan ke Bumi selepas digoda Iblis memakan buah Khuldi.", icon: <Leaf className="w-5 h-5" />, color: goldGradient },
    { id: 2, title: "Nabi Idris AS", content: "Nabi pertama yang pandai menulis dengan pena dan menjahit pakaian. Mempunyai ilmu falak yang tinggi.", icon: <Pen className="w-5 h-5" />, color: goldGradient },
    { id: 3, title: "Nabi Nuh AS", content: "Membina bahtera besar atas perintah Allah. Banjir besar melanda dunia menenggelamkan kaumnya yang kafir.", icon: <Ship className="w-5 h-5" />, color: goldGradient },
    { id: 4, title: "Nabi Hud AS", content: "Diutus kepada kaum 'Ad yang sombong. Allah memusnahkan mereka dengan angin puting beliung yang sangat sejuk.", icon: <Wind className="w-5 h-5" />, color: goldGradient },
    { id: 5, title: "Nabi Saleh AS", content: "Mukjizat seekor unta betina keluar dari batu. Kaum Tsamud dibinasakan dengan suara guntur kerana membunuh unta itu.", icon: <Info className="w-5 h-5" />, color: goldGradient },
    { id: 6, title: "Nabi Ibrahim AS", content: "Bapa para Nabi. Tidak hangus dibakar api Raja Namrud. Membina Kaabah bersama anaknya Nabi Ismail AS.", icon: <Flame className="w-5 h-5" />, color: goldGradient },
    { id: 7, title: "Nabi Luth AS", content: "Diutus kepada kaum Sadum. Allah menterbalikkan bumi mereka kerana melakukan maksiat yang melampaui batas.", icon: <Mountain className="w-5 h-5" />, color: goldGradient },
    { id: 8, title: "Nabi Ismail AS", content: "Asal usul air Zamzam. Redha disembelih oleh bapanya sebelum digantikan Allah dengan seekor kibas.", icon: <Droplets className="w-5 h-5" />, color: goldGradient },
    { id: 9, title: "Nabi Ishaq AS", content: "Anak kedua Ibrahim. Lahir dari Siti Sarah yang sudah tua. Menjadi nenek moyang kepada ramai Nabi Bani Israil.", icon: <BookOpen className="w-5 h-5" />, color: goldGradient },
    { id: 10, title: "Nabi Yaqub AS", content: "Bapa kepada Nabi Yusuf. Sangat penyabar menghadapi ujian kehilangan anaknya sehingga matanya menjadi buta.", icon: <Heart className="w-5 h-5" />, color: goldGradient },
    { id: 11, title: "Nabi Yusuf AS", content: "Memiliki wajah yang sangat tampan. Dibuang ke perigi oleh abangnya, akhirnya menjadi menteri yang sangat berkuasa di Mesir.", icon: <Crown className="w-5 h-5" />, color: goldGradient },
    { id: 12, title: "Nabi Ayub AS", content: "Ujian penyakit kulit yang sangat lama. Beliau tetap sabar dan tidak berhenti berzikir kepada Allah SWT.", icon: <Heart className="w-5 h-5" />, color: goldGradient },
    { id: 13, title: "Nabi Syuaib AS", content: "Digelar Khatibul Anbiya. Mengajar kaumnya supaya jujur dalam timbangan dan tidak menipu dalam perniagaan.", icon: <Scale className="w-5 h-5" />, color: goldGradient },
    { id: 14, title: "Nabi Musa AS", content: "Mukjizat tongkat membelah laut dan mengalahkan sihir Firaun. Menerima kitab Taurat di Bukit Sinai.", icon: <Waves className="w-5 h-5" />, color: goldGradient },
    { id: 15, title: "Nabi Harun AS", content: "Saudara Nabi Musa. Mempunyai tutur bicara yang sangat fasih dan membantu dakwah Musa menentang Firaun.", icon: <Info className="w-5 h-5" />, color: goldGradient },
    { id: 16, title: "Nabi Zulkifli AS", content: "Seorang Nabi yang sangat amanah dan sabar. Beliau memerintah rakyatnya dengan adil dan sentiasa menepati janji.", icon: <Gem className="w-5 h-5" />, color: goldGradient },
    { id: 17, title: "Nabi Daud AS", content: "Boleh melenturkan besi dengan tangan dan mempunyai suara merdu. Menerima kitab Zabur dan mengalahkan Jalut.", icon: <Music className="w-5 h-5" />, color: goldGradient },
    { id: 18, title: "Nabi Sulaiman AS", content: "Nabi paling kaya. Boleh memerintah jin, haiwan, dan angin. Membina Haikal Sulaiman dan mengislamkan Ratu Balqis.", icon: <Crown className="w-5 h-5" />, color: goldGradient },
    { id: 19, title: "Nabi Ilyas AS", content: "Menyeru kaumnya berhenti menyembah berhala Ba'al. Meminta doa agar diturunkan hujan selepas kemarau panjang.", icon: <Sun className="w-5 h-5" />, color: goldGradient },
    { id: 20, title: "Nabi Ilyasa AS", content: "Penerus dakwah Nabi Ilyas. Diberikan mukjizat menyembuhkan penyakit dan memimpin Bani Israil dengan hikmah.", icon: <BookOpen className="w-5 h-5" />, color: goldGradient },
    { id: 21, title: "Nabi Yunus AS", content: "Ditelan ikan nun (paus). Di dalam perut ikan, beliau sentiasa berzikir memohon ampun sehingga dikeluarkan Allah.", icon: <Waves className="w-5 h-5" />, color: goldGradient },
    { id: 22, title: "Nabi Zakaria AS", content: "Bapa Nabi Yahya. Menjaga Maryam di Mihrab. Walaupun sudah sangat tua, Allah mengurniakan anak atas doanya.", icon: <Info className="w-5 h-5" />, color: goldGradient },
    { id: 23, title: "Nabi Yahya AS", content: "Anak Zakaria yang sangat lembut hatinya dan berani. Menegakkan hukum Allah tanpa rasa takut kepada raja yang zalim.", icon: <Feather className="w-5 h-5" />, color: goldGradient },
    { id: 24, title: "Nabi Isa AS", content: "Lahir tanpa bapa. Boleh bercakap masa bayi dan menghidupkan orang mati dengan izin Allah. Akan turun semula di akhir zaman.", icon: <Cloud className="w-5 h-5" />, color: goldGradient },
    { id: 25, title: "Nabi Muhammad SAW", content: "Nabi dan Rasul terakhir. Mukjizat terbesar ialah Al-Quran. Membawa ajaran Islam untuk seluruh alam semesta.", icon: <Star className="w-5 h-5" />, color: goldGradient }
  ]
};
            ...
            {filterData(view === 'nabawiyah' ? sirahData.nabawiyah : sirahData.paraNabi).map((item) => (
              <div key={item.id} className="bg-white dark:bg-slate-900 rounded-[28px] p-5 flex flex-col items-center text-center shadow-sm border border-amber-500/10">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-gradient-to-r from-[#d4af37] to-[#b8860b] text-white text-[10px] font-black rounded-xl active:scale-95"
                >
                  BACA
                </button>
              </div>
                ...
                {selectedStory.isNovel ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <button 
                      ...
                      className="w-full py-5 bg-gradient-to-r from-[#d4af37] to-[#b8860b] text-white rounded-[25px] font-black text-xs uppercase tracking-widest shadow-lg active:scale-95"
                    >
                      SELESAI MEMBACA
                    </button>
                  </div>
