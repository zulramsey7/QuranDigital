    ...
    <MainLayout>
      <div className="space-y-6 animate-fade-in pb-24">
        ...
        <div className="flex items-center justify-between px-1">
          ...
          <Link to="/settings" className="w-10 h-10 rounded-2xl bg-secondary/50 flex items-center justify-center text-muted-foreground active:scale-95 transition-all">
            <Settings className="w-5 h-5" />
          </Link>
        </div>

        {/* Avatar & Info Card */}
        <div className="relative overflow-hidden rounded-[32px] p-8 flex flex-col items-center bg-gradient-to-b from-emerald-500/15 to-transparent border border-emerald-500/10 shadow-xl">
        ...
        <div className="grid grid-cols-3 gap-3">
          {stats.map((stat, i) => (
            <div key={i} className="p-4 rounded-[24px] text-center bg-white dark:bg-secondary/20 border border-black/5 dark:border-white/5 shadow-sm transition-all active:scale-95">
        ...
        <div className="space-y-3">
          <Link to="/settings" className="p-4 rounded-[24px] flex items-center justify-between group bg-white dark:bg-secondary/10 border border-black/5 dark:border-white/5 shadow-sm active:bg-emerald-500/5 transition-colors">
