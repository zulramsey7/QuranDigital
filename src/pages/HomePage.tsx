...
export default function HomePage() {
  ...
  const features = [
    ...
    { label: 'Profil', icon: User, path: '/profile', color: 'bg-emerald-500/10 text-emerald-500' },
    { label: 'Tetapan', icon: Settings, path: '/settings', color: 'bg-emerald-500/10 text-emerald-500' },
  ];
