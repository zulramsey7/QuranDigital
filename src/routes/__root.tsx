...
import { OG_IMAGE_URL, SITE_NAME, SITE_TAGLINE } from "../lib/site-meta";
  ...
  head: () => ({
    meta: [
      ...
      { title: "JomNgaji – Al-Quran Digital Untuk Semua" },
      {
        name: "description",
        content:
          "Aplikasi Al-Quran digital yang moden: bacaan Quran, waktu solat, arah kiblat, audio murottal dan bookmark. Muat turun percuma di Google Play.",
      },
